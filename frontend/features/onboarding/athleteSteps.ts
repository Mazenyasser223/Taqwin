...
export const RAW_ATHLETE_STEPS: OnboardingStep[] = [
    ...
    options: [
      {
        value: 'ectomorph',
        label: 'Ectomorph',
        description: 'Lean build, hard to gain mass',
        imageUrl: ASSETS.bodyEctomorph,
      ...
      },
      {
        ...
        imageUrl: ASSETS.bodyMesomorph,
        imageVariant: 'illustration',
      },
      {
        value: 'endomorph',
        label: 'Endomorph',
        description: 'Stores fat easily',
        imageUrl: ASSETS.bodyEndomorph,
        imageVariant: 'illustration',
      },
    ],
  },
    ...
    options: [
      {
        value: 'Build Muscle',
        label: 'Build muscle',
        description: 'Gain size and full-body strength',
        imageUrl: ASSETS.goalMuscle,
        imageVariant: 'photo',
      },
      {
        value: 'Lose Weight',
        ...
        imageUrl: ASSETS.goalWeight,
        imageVariant: 'photo',
      },
      {
        value: 'Improve Endurance',
        label: 'Endurance & conditioning',
        description: 'Cardio capacity and stamina',
        imageUrl: ASSETS.goalEndurance,
        imageVariant: 'photo',
      },
      {
        value: 'Stay Healthy',
        label: 'Wellness & balance',
        description: 'Energy, recovery, and wellbeing',
        imageUrl: ASSETS.goalWellness,
        imageVariant: 'photo',
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'ankles', label: 'Ankles', imageUrl: ASSETS.injuryKnees },
      ...
      { value: 'wrists', label: 'Wrists', imageUrl: ASSETS.injuryArms },
      { value: 'hips', label: 'Hips', imageUrl: ASSETS.injuryLegs },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'football', label: 'Football / soccer', description: 'Schedule leg work around match days' },
      ...
      { value: 'other', label: 'Other', description: 'Type your sport' },
      { value: 'none', label: 'No' },
    ],
  },
  ...
  },
  {
    ...
    section: 'health',
    type: 'single',
    title: 'How much plain water do you drink daily?',
    visualOptions: false,
    autoAdvance: true,
    options: [
      { value: 'lt1_liter', label: 'Less than 1 L' },
      { value: '1_2_liters', label: '1–2 L' },
      { value: '2_3_liters', label: '2–3 L' },
      { value: 'gt3_liters', label: 'More than 3 L' },
      {
        value: 'mostly_tea_coffee',
        label: 'Mostly tea / coffee',
        description: 'Low plain-water intake — we’ll nudge you to hydrate',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    section: 'health',
    type: 'multi',
    title: 'Which eating habits apply to you?',
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'other', label: 'Other', description: 'Type your event' },
