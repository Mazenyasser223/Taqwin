...
class Settings(BaseSettings):
    ...
    # Block B6 — RAG retriever tuning (lower defaults = smaller coach prompts)
    rag_limit_per_level: int = 4
    ...
    coach_max_tool_loops: int = 2
    coach_summarize_after_tools: bool = False
    coach_history_max_messages: int = 10
    ...
    meal_vision_model: str = "claude-sonnet-4-5"
    meal_vision_max_tokens: int = 2048
