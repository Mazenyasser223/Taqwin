-- Remove legacy profiles table if it still exists (e.g. out-of-band repair recreated it).
-- Fresh CI DBs already migrated and dropped profiles in split_profiles_remove_trainer.
