...
const ONBOARDING_QUESTION_CATALOG = [
  ...
  { flow: 'diet', stepId: 'supplementsBudget', sortOrder: 14, titleAr: 'مكملات', reasonAr: 'اختياري — يوضح المكملات الحالية فقط.' },
  ...
  { flow: 'diet', stepId: 'mealPrepTime', sortOrder: 16, titleAr: 'وقت تحضير الأكل', reasonAr: 'نطاقات واقعية (٠–١٥ / ١٥–٣٠ / ٣٠–٦٠ / ساعة+).' },
  { flow: 'diet', stepId: 'cookOrReady', sortOrder: 17, titleAr: 'هل تطبخ أم تأكل جاهز؟', reasonAr: 'شكل الوجبات.' },
  { flow: 'diet', stepId: 'religiousDiet', sortOrder: 18, titleAr: 'قيود دينية أو ثقافية', reasonAr: 'حلال، رمضان، صيام مسيحي، نباتي صارم — أو لا.' },
  // ── Wellness (8) ──
